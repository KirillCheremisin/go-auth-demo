...
const (
	...
	UserService_UpdateUserProfile_FullMethodName = "/auth.UserService/UpdateUserProfile"
)
...
func (c *userServiceClient) GetUserProfile(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*UserProfile, error) {
...
func (UnimplementedUserServiceServer) GetUserProfile(context.Context, *GetUserRequest) (*UserProfile, error) {
