...
## 📋 Краткое описание
Простое демонстрационное приложение на Go, реализующее различные способы аутентификации и авторизации. Поддерживает session-based аутентификацию через Redis и token-based аутентификацию через JWT.
